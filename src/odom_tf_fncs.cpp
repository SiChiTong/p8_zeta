...
void OdomTf::odomCallback(const nav_msgs::Odometry& odom_rcvd) {
    ...
    //stfDriftyOdomWrtBase_.child_frame_id_ = "odom"; // make this legal for multiply
    ...
    //DriftyOdomWrtMap is transform of our odom frame with respect to the map frame.
...
// We can re-use the transform: odom w/rt map repeatedly (e.g. at 50Hz, coincident with drifty-odom publication updates)
