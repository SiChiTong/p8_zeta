...
#include <queue>
#include <stack>
#include <p8_zeta/traj_builder.h> //has almost all the headers we need
#include <std_msgs/Bool.h>
#include <std_srvs/Trigger.h>
#include <p8_zeta/path.h>
...
private:
    ...
    bool appendPathQueueCB(p8_zeta::pathRequest& request, p8_zeta::pathResponse& response);
